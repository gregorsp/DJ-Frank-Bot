...
var InputHandler = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 31];
                    case 1: return [4 /*yield*/, this.debug(message, serverQueue)];
                    case 2:
                        matches = _b.sent();
                        i = 0;
                        _b.label = 3;
                    case 3:
                        ...
                        serverQueue = this.queueGet(message.guild.id);
                        return [4 /*yield*/, this.play(message, serverQueue)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
                    ...
                    case 12:
                        ...
                        return [3 /*break*/, 32];
                    case 13:
                        length = message.content.length > 8 ? this.getNthWord(message.content, 2) : 1;
                        if (length > 10)
                            length = 10;
                    ...
                    case 19: return [4 /*yield*/, this.fabian(message, serverQueue, "30YalNqYddehoSL44yETCo")];
                    case 20:
                        titles = _b.sent();
                        if (titles.length == 0) {
                    ...
                    case 25:
                        spotLink = this.getNthWord(message.content, 2);
                        spotId = this.getSpotifyPlaylistId(spotLink);
                        count = 1;
                        try {
    ...
    InputHandler.prototype.play = function (message, serverQueue) {
    ...
    InputHandler.prototype.skip = function (message, serverQueue) {
    ...
    InputHandler.prototype.clearQueue = function (message, serverQueue) {
        if (!message.member.voice.channel)
            return message.channel.send("Du bist in keinem Voice!");
        if (!serverQueue)
            return message.channel.send("Queue ist leer!");
    ...
    InputHandler.prototype.playlist = function (message, serverQueue) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.say = function (message) {
        this.sayCommand(message);
    };
    InputHandler.prototype.spotify = function (playlistId, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InputHandler.prototype.fabian = function (message, serverQueue, playlistId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.debug = function (message, serverQueue) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.getPlaylistFromDatabase = function (playlistId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.isValidHttpUrl = function (string) {
        var url;
        try {
            url = new URL(string);
        }
    ...
    InputHandler.prototype.setServerQueue = function (message) {
        var queueContruct = {
    ...
    InputHandler.prototype.songInfoToSongObject = function (songInfo) {
        return {
    ...
    InputHandler.prototype.getNthWord = function (text, n) {
        return text.split(" ")[n - 1];
    };
    InputHandler.prototype.getSpotifyPlaylistId = function (link) {
    ...
    InputHandler.prototype.tryPlay = function (voiceChannel, serverQueue, message) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.reallyPlay = function (guild, song) {
        var _this = this;
    ...
    InputHandler.prototype.queueGet = function (guildId) {
        return this.queue.get(guildId);
    };
    InputHandler.prototype.queueSet = function (guildId, queueContruct) {
        return this.queue.set(guildId, queueContruct);
    };
    InputHandler.prototype.queueDelete = function (guildId) {
        return this.queue.delete(guildId);
    };
    InputHandler.prototype.queueAdd = function (id, serverQueue, message) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.getSongInfo = function (arg) {
        return __awaiter(this, void 0, void 0, function () {
            var liste, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isValidHttpUrl(arg)) return [3 /*break*/, 2];
    ...
    InputHandler.prototype.getPlaylistInfo = function (arg) {
        return __awaiter(this, void 0, void 0, function () {
            var liste;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InputHandler.prototype.getMusicEmbed = function (videoDetails, queue) {
    ...
    InputHandler.prototype.sendSongToChat = function (serverQueue, song) {
    ...
    InputHandler.prototype.sendAddedToQueue = function (channel, song) {
        return channel.send("".concat(song.title, " wurde zur Queue hinzugef\u00FCgt!"));
    };
    InputHandler.prototype.sayCommand = function (message) {
        var answer = message.content.slice(5);
        message.channel.send(answer);
        message.delete();
    };
    InputHandler.prototype.getAccesToken = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InputHandler.prototype.doRequest = function (url) {
    ...
    InputHandler.prototype.GetRandomSongsFromPlaylist = function (playlistId, amount) {
    ...
    InputHandler.prototype.apiTrackToText = function (track) {
        var artist = track.track.artists[0].name;
        var title = track.track.name;
        return artist + " - " + title;
    };
    InputHandler.prototype.GetMatchingSongsFromPlaylist = function (playlistId, interprets) {
        if (playlistId === void 0) { playlistId = "30YalNqYddehoSL44yETCo"; }
        return __awaiter(this, void 0, void 0, function () {
